...
WebUI.click(findTestObject('Products/TemplateApp/Templates/SharedAssets/PartialsYML/span_LAYOUTS'))

WebUI.delay(2)

WebUI.click(findTestObject('Products/TemplateApp/Templates/SharedAssets/PartialsYML/TwoColumnNJK'))

WebUI.delay(2)

WebUI.verifyElementText(findTestObject('Products/TemplateApp/Templates/Common/FormHeaderText'), 'TWO-COLUMN.NJK')
