...
WebUI.click(findTestObject('Products/TemplateApp/Templates/SharedAssets/PartialsYML/CSSNJK'))

WebUI.delay(2)

WebUI.verifyElementText(findTestObject('Products/TemplateApp/Templates/Common/FormHeaderText'), 'CSS.NJK')
