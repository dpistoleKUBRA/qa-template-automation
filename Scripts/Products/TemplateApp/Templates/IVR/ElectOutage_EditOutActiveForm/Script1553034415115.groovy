...
WebUI.click(findTestObject('Products/TemplateApp/Templates/IVR/SelectIVR'))

WebUI.click(findTestObject('Products/TemplateApp/Templates/Common/span_ELECT-OUTAGE'))
WebUI.delay(4)
WebUI.click(findTestObject('Products/TemplateApp/Templates/Common/ElectOutage_OutActiveForm'))

WebUI.delay(4)

WebUI.click(findTestObject('Products/TemplateApp/Templates/Common/SelectTextareaSpan'))

CustomKeywords.'tools.WebUICustomKeywords.enterUsingJS'(findTestObject('Products/TemplateApp/Templates/Common/Textarea'), 10)
...
WebUI.verifyElementText(findTestObject('Products/TemplateApp/Templates/Common/VerifyCommitMessageField'), commitNumber)
