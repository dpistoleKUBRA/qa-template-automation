...
WebUI.click(findTestObject('Products/TemplateApp/Templates/IVR/VoiceOptionReportOutageForm'))

WebUI.verifyElementText(findTestObject('Products/TemplateApp/Templates/Common/FormHeaderText'), 'VOICE_OPTION_REPORT_OUTAGE.NJK')
