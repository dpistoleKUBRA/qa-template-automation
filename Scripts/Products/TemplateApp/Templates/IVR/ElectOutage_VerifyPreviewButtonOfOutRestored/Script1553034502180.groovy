...
WebUI.delay(2)
WebUI.click(findTestObject('Products/TemplateApp/Templates/Common/ElectOutage_OutRestoredForm'))

WebUI.verifyElementText(findTestObject('Products/TemplateApp/Templates/Common/FormHeaderText'), 'OUT_RESTORED.NJK')
