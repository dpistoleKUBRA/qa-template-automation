...
WebUI.click(findTestObject('Products/TemplateApp/Templates/IVR/VoiceDisenrolledForm'))

WebUI.verifyElementText(findTestObject('Products/TemplateApp/Templates/Common/FormHeaderText'), 'VOICE_DISENROLLED.NJK')
