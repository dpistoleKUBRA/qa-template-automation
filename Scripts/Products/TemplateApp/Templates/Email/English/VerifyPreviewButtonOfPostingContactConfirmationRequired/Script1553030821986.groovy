...
WebUI.click(findTestObject('Products/TemplateApp/Templates/Email/PostingContactConfirmationRequiredForm'))

WebUI.verifyElementText(findTestObject('Products/TemplateApp/Templates/Common/FormHeaderText'), 'POSTING_CONTACT_CONFIRMATION_REQUIRED.NJK')
