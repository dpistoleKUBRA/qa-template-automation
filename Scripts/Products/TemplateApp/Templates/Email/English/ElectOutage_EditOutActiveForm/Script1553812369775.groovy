...
WebUI.click(findTestObject('Products/TemplateApp/Templates/Common/span_ELEC-OUTAGE'))
...
WebUI.click(findTestObject('Products/TemplateApp/Templates/IVR/ElectOutage_OutActiveForm'))
