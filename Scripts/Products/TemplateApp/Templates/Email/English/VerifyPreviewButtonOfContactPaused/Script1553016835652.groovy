...
WebUI.click(findTestObject('Products/TemplateApp/Templates/Email/PostingRegistrationAffirmationForm'))

WebUI.verifyElementText(findTestObject('Products/TemplateApp/Templates/Common/FormHeaderText'), 'POSTING_REGISTRATION_AFFIRMATION.NJK')
