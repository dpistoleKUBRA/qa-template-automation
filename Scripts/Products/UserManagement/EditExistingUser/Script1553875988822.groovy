...
WebUI.click(findTestObject('Products/UserManagement/EditUserButton'))
...
WebUI.waitForElementClickable(findTestObject('Products/UserManagement/CreateUserAccount'), 5)
