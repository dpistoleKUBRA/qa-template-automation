...
WebUI.setEncryptedText(findTestObject('Products/UserManagement/Password'), 
    'ondo5HWRPO/HqnDYAr/Deg==')

WebUI.setEncryptedText(findTestObject('Products/UserManagement/PasswordConfirmation'), 'ondo5HWRPO/HqnDYAr/Deg==')

WebUI.click(findTestObject('Products/UserManagement/SelectPermissions'))

WebUI.delay(4)

WebUI.click(findTestObject('Products/UserManagement/StormCenterInstanceAdmin'))

WebUI.click(findTestObject('Products/UserManagement/SaveButton'))

WebUI.waitForElementClickable(findTestObject('Products/UserManagement/CreateUserAccount'), 
    15)
