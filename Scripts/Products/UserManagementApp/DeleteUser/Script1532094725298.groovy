...
WebUI.waitForElementClickable(findTestObject('Products/StormCenterSwift/StormCenter/UserManagement/01-qa-user-99DeleteButton'), 
    15)

WebUI.click(findTestObject('Products/StormCenterSwift/StormCenter/UserManagement/01-qa-user-99DeleteButton'))

WebUI.verifyTextPresent('01qauser99@kubra.com', false)

WebUI.click(findTestObject('Products/StormCenterSwift/StormCenter/UserManagement/ConfirmDeleteButton'))
